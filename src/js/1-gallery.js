import SimpleLightbox from "simplelightbox";  // Если используешь модули
import "simplelightbox/dist/simple-lightbox.min.css"; // Подключи стили
...
const images = [
  ...
  const imagesMarkup = createImagesCard(images);
...
//     }
    ...
    // instance.show();
      // Инициализация lightbox на ссылках внутри .gallery
const lightbox = new SimpleLightbox('.gallery a', {
    captionsData: "alt", // Берёт подпись из атрибута alt
    captionDelay: 250 // Задержка показа подписи (мс)
});
